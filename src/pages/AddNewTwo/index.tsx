...
import bitcoin from "../../assests/Images/bitcoinicon.png";
import BNB from "../../assests/Images/BB.png";
import ethIcon from "../../assests/Images/ethi.png";
import cardanoIcon from "../../assests/Images/cardano.png";
import litecoinIcon from "../../assests/Images/litecoin.png";
import tronIcon from "../../assests/Images/tron.svg";
import dogecoinIcon from "../../assests/Images/dogecoin.svg";
          ...
          >
            ...
            >
              ...
              <Box
                ...
                onClick={changebg2}
              >
                <Box sx={{ marginLeft: { lg: "0px", xs: "0px"}, display: "-webkit-box", gap: "10px"}} >
                  <img src={BNB} alt="" width={40} height={40} />
                  <Box>
                    <Typography
                      sx={{
                        color: "#111827",
            ...
            >
              <Box mt="41px">
                <label className={classes.lableinput}>
                  ...
                  >
                    <Box sx={{display: "-webkit-flex", gap: "10px"}}>
                    <img src={bitcoin} alt=""/>
                    <Box>
                      <Typography
                        sx={{
                ...
                <label className={classes.lableinput}>
                  ...
                  >
                    <Box sx={{display: "-webkit-flex", gap: "10px"}}>
                      <img src={ethIcon} alt="" width={40} height={40}/>
                      <Box>
                        <Typography
                          sx={{
                            fontFamily: "Inter !important",
                ...
                <label className={classes.lableinput}>
                  ...
                  >
                    <Box sx={{display: "-webkit-flex", gap: "10px"}}>
                      <img src={cardanoIcon} alt="" width={40} height={40}/>
                      <Box>
                        <Typography
                          sx={{
                            fontFamily: "Inter !important",
                ...
                <label className={classes.lableinput}>
                  ...
                  >
                    <Box sx={{display: "-webkit-flex", gap: "10px"}}>
                      <img src={litecoinIcon} alt="" width={40} height={40}/>
                      <Box>
                        <Typography
                          sx={{
                            fontFamily: "Inter !important",
                ...
                <label className={classes.lableinput}>
                  ...
                  >
                    <Box sx={{display: "-webkit-flex", gap: "10px"}}>
                      <img src={tronIcon} alt="" width={40} height={40}/>
                      <Box>
                        <Typography
                          sx={{
                            fontFamily: "Inter !important",
                ...
                <label className={classes.lableinput}>
                  ...
                  >
                    <Box sx={{display: "-webkit-flex", gap: "10px"}}>
                      <img src={dogecoinIcon} alt="" width={40} height={40}/>
                      <Box>
                        <Typography
                          sx={{
                            fontFamily: "Inter !important",
