...
const Paymentdone = () => {
  ...
  const _amount = amount?parseFloat(amount):0;
  const transFee = useTransferFee(_amount,tokenName);

  const Payment = useMemo(()=>{
    return [
      {
        name: " You Sent",
        info: `${_amount} ${tokenName}`,
      },
      {
        name: " Transfer Rate",
        info: "1 BUSD = 1 EUR ",
      ...
      {
        name: "Total to pay",
        info: `${_amount+transFee} ${tokenName}`,
      },
      {
        name: " Recipient Gets",
        info: "100.00 EUR",
